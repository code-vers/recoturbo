...
const DynamicTitle = ({ text }) => {
  return (
    <div
      className='relative w-full h-auto py-10 md:py-22 lg:py-40 bg-[#ebe7e4] flex justify-center items-center'
      style={{
        isolation: "isolate",
        backgroundImage:
      ...
      <div className='text-center px-4 max-w-5xl '>
        ...
        <div className='flex items-center md:text-[35px] lg:text-[35px] flex lg:text-[70px] lg:leading-[70px] text-black'>
          <p>FROM VISION</p>
          <div>
